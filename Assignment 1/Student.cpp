...
void Student::print(ostream& out, double avgCGPA, double avgSubjectsPerSemester, double avgCreditHoursPerSemester)
{

	out << fixed << setprecision(5);
	out << "Average CGPA: " << avgCGPA << endl;
	out << fixed << setprecision(2);
	out << "Average Subjects Taken Per Semester: " << avgSubjectsPerSemester << endl;
	out << "Average Credit Hours Earned Per Semester: " << avgCreditHoursPerSemester << endl << endl;
